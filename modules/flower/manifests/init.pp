class flower ($venv_path = '/var/www/flower') {
    ...
    supervisor::template_supervisor_conf { 'flower_prod': 
        appname   => 'flower',
        directory => "$venv_path",
        command   => "$venv_path/bin/celery flower --broker=amqp://edgeflip:edgeflip@rabbit.efprod.com:5672/edgehost --broker_api=http://admin:303ewacker@rabbit.efprod.com:15672/api/ --basic_auth=edgeflip:303ewacker",
    }
